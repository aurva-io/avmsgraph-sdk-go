...
func (m *Task) GetArguments()([]iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable) {
    val, err := m.GetBackingStore().Get("arguments")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable)
    }
    return nil
}
...
func (m *Task) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["arguments"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.CreateKeyValuePairFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable)
                }
            }
            m.SetArguments(res)
        }
...
func (m *Task) SetArguments(value []iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable)() {
...
type Taskable interface {
    ...
    GetArguments()([]iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable)
    ...
    SetArguments(value []iff6ba9ca3c965d94e15ab7aa30386d60bd694ee3b15d5295d3980a9418fbbab0.KeyValuePairable)()
